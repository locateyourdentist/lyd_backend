...
// router.get('/districts/:state',notificationController.getdistrict)
// router.get('/subdistricts/:district',notificationController.getsubdistricts)
// router.get('/villages/:subDistrict',notificationController.getvillages)
